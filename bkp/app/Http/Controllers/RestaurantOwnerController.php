...
class RestaurantOwnerController extends Controller
{
    ...
    public function acceptOrder($id)
    {
        ...
        if ($order->orderstatus_id == '1') {
            ...
            return redirect()->back()->with(array('success' => 'Pedido aceito'));
        } else {
    ...
    public function markOrderReady($id)
    {
        ...
        if ($order->orderstatus_id == '2') {
            ...
            return redirect()->back()->with(array('success' => 'Pedido pronto'));
        } else {
            return redirect()->back()->with(array('message' => 'Algo deu errado!'));
        }
    }
    ...
    public function markSelfPickupOrderAsCompleted($id)
    {
        ...
        if ($order->orderstatus_id == '7') {
            ...
            return redirect()->back()->with(array('success' => 'Pedido feito'));
        } else {
            return redirect()->back()->with(array('message' => 'Algo deu errado!'));
        }
    }
    ...
    public function getEditRestaurant($id)
    {
        ...
        if ($restaurant) {
            ...
            return redirect()->route('restaurant.restaurants')->with(array('message' => 'Acesso negado'));
        }
    }
    ...
    public function disableRestaurant($id)
    {
        ...
        if ($restaurant) {
            ...
            return redirect()->back()->with(array('success' => 'Sucesso'));
        } else {
    ...
    public function saveNewRestaurant(Request $request)
    {
        ...
        try {
            ...
            return redirect()->back()->with(array('success' => 'Loja Salvo'));
        } catch (\Throwable $th) {
...
//            $restaurant->commission_rate = $request->commission_rate;
    ...
    public function createItemCategory(Request $request)
    {
        ...
        try {
            $itemCategory->save();
            return redirect()->back()->with(array('success' => 'Categoria criada!'));
        } catch (\Throwable $th) {
            return redirect()->back()->with(array('message' => $th));
        }
    }
    ...
    public function getEditItem($id)
    {
        ...
        if ($item) {
            ...
            return redirect()->route('restaurant.items')->with(array('message' => 'Acesso negado'));
        }
    }
    ...
    public function updateItem(Request $request)
    {
        ...
        if ($item) {
            ...
            try {
                ...
                return redirect()->back()->with(array('success' => 'Salvo'));
            } catch (\Throwable $th) {
                return redirect()->back()->with(array('message' => $th));
            }
        }
    ...
    public function saveNewAddonCategory(Request $request)
    {
        ...
        try {
            ...
            return redirect()->back()->with(array('message' => 'Erro,  tente novamente.'));
        } catch (Exception $e) {
        ...
        if ($addonCategory) {
            if ($addonCategory->user_id == Auth::user()->id) {
                ...
                return redirect()
                    ...
                    ->with(array('message' => 'Acesso negado'));
            }
        } else {
            return redirect()
                ->route('restaurant.editAddonCategory')
    ...
    public function updateAddonCategory(Request $request)
    {
        ...
        if ($addonCategory) {
            ...
            try {
                $addonCategory->save();
                return redirect()->back()->with(array('success' => 'Atualizado'));
            } catch (\Illuminate\Database\QueryException $qe) {
                return redirect()->back()->with(array('message' => 'Erro, Tente novamente'));
            } catch (Exception $e) {
                return redirect()->back()->with(array('message' => $e->getMessage()));
    ...
    public function getEditAddon($id)
    {
        ...
        if ($addon) {
            ...
            return redirect()->route('restaurant.addons')->with(array('message' => 'Acesso negado'));
        }
    }
        ...
        if ($restaurant_id) {
            ...
            if ($restaurant) {
                ...
                if ($contains) {
                    ...
                    return redirect()->route('restaurant.earnings')->with(array('message' => 'Acesso negado'));
                }
            } else {
                return redirect()->route('restaurant.earnings')->with(array('message' => 'Acesso negado'));
            }
    ...
    public function cancelOrder($id)
    {
        ...
        if ($order) {
            if ($order->orderstatus_id == '1') {
                ...
                return redirect()->back()->with(array('success' => 'Pedido cancelado'));
            }
        } else {
            return redirect()->back()->with(array('message' => 'Erro'));
        }
    }
}
