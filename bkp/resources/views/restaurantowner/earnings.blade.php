...
@section("title") Ganhos e pagamentos - Dashboard
@endsection
@section('content')
<div class="content">
    ...
    <div class="row">
        <div class="form-group row mt-5">
            <label class="col-lg-12 col-form-label"><span class="text-danger">*</span>Selecione o Loja:</label>
            <div class="col-lg-12">
    ...
    <div class="row mt-4">
            ...
            <div class="col-xl-12 dashboard-display p-3">
                <a class="block block-link-shadow text-right" href="javascript:void(0)">
                    <div class="block-content block-content-full clearfix">
                        <div class="text-center" style="color: #717171; font-weight: 500;">Lucro líquido antes da comissão</div>
        ...
        <div class="col-12 col-xl-4 mb-2">
            <div class="col-xl-12 dashboard-display p-3">
                <a class="block block-link-shadow text-right" href="javascript:void(0)">
                    <div class="block-content block-content-full clearfix">
                        <div class="text-center" style="color: #717171; font-weight: 500;">Seu saldo (após a comissão de <strong>{{ $restaurant->commission_rate }}%)</strong></div>
        ...
        <div class="col-12 col-xl-4 mb-2">
            <div class="col-xl-12 dashboard-display p-3">
                <a class="block block-link-shadow text-right" href="javascript:void(0)">
                    <div class="block-content block-content-full clearfix">
                        <div class="text-center" style="color: #717171; font-weight: 500;">Valor total de suas vendas, antes da comissão</div>
    ...
    <div class="container">
        <div class="row mt-5">
            <div class="col-xl-12 p-3" style="border-radius: 4px; background-color: #fff; box-shadow: 0 1px 6px 1px rgba(0, 0, 0, 0.05);">
                <h4>
                    <strong>Pedido de Pagamento</strong>
                </h4>

                @if(!((double)$balanceAfterCommission > (double)config('settings.minPayout')))
                <p>
                    Seu saldo atual é de <strong>{{ config('settings.currencyFormat') }}{{$balanceAfterCommission}}</strong>. Você será elegível para um pagamento quando o valor do seu saldo ultrapassar <strong>{{ config('settings.currencyFormat') }}{{ config('settings.minPayout') }}</strong>.
                </p>
                <i class="icon-exclamation" style="position: absolute; font-size: 5rem; color: #FF5722; right: 15px; top: 15px; opacity: 0.1;"></i>
                @else
                <button class="btn btn-primary btn-lg" data-toggle="modal" data-target="#sendPayoutRequest">Solicitar Pagamento</button>
                    ...
                    <div class="modal-dialog modal-sm">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title"><span class="font-weight-bold">Solicitar Pagamento</span></h5>
                                <button type="button" class="close" data-dismiss="modal">&times;</button>
                            </div>
                            <div class="modal-body">
                                <span class="help-text">
                                    Você está solicitando o pagamento de <strong>{{ config('settings.currencyFormat') }}{{$balanceAfterCommission}}</strong>
                                </span>
