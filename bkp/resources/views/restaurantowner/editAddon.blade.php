...
@section("title") Editar Adicionais - Dashboard
@endsection
@section('content')
            ...
            <div class="card-body">
                <form action="{{ route('restaurant.updateAddon') }}" method="POST" enctype="multipart/form-data">
                    <legend class="font-weight-semibold text-uppercase font-size-sm">
                        <i class="icon-address-book mr-2"></i> Detalhes do Adicional
                    </legend>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9">
                            <input value="{{ $addon->price }}" type="text" class="form-control form-control-lg price" name="price"
                                placeholder="Preço em {{ config('settings.currencyFormat') }}" required>
                        </div>
                    </div>
                    <div class="form-group row">
