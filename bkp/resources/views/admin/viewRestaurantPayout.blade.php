...
@section("title") Pagamentos do Loja - Dashboard
@endsection
@section('content')
<div class="content">
    <div class="row mt-4">
        	...
        	<div class="card">
	            ...
	            <form action="{{ route('admin.updateRestaurantPayout') }}" method="POST" enctype="multipart/form-data">
	                <legend class="font-weight-semibold text-uppercase font-size-sm">
	                    <i class="icon-address-book mr-2"></i> Pagamento do Loja
	                </legend>
