    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"><span class="font-weight-bold">Adicionar Novo Item</span></h5>
            ...
            <div class="modal-body">
                <form action="{{ route('admin.saveNewItem') }}" method="POST" enctype="multipart/form-data">
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9">
                            <input type="text" class="form-control form-control-lg" name="name" placeholder="Nome do Item"
                                required>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-lg-3 col-form-label">DescriÃ§Ã£o do Item</label>
                        <div class="col-lg-9">
                            <textarea class="summernote-editor" name="desc" placeholder="DescriÃ§Ã£o do Item"
                                rows="6"></textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group row" style="display: none;" id="discountedTwoPrice">
                        <div class="col-lg-6">
                            <label class="col-form-label">PreÃ§o: <i class="icon-question3 ml-1"
                                    data-popup="tooltip" title="Torne este campo vazio ou zero se nÃ£o for necessÃ¡rio"
                                    data-placement="top"></i></label>
                            <input type="text" class="form-control form-control-lg price" name="old_price"
                                placeholder="PreÃ§o do item em {{ config('settings.currencyFormat') }}">
                        </div>
                        <div class="col-lg-6">
                            <label class="col-form-label"><span class="text-danger">*</span>PreÃ§o de Venda:</label>
                            <input type="text" class="form-control form-control-lg price" name="price"
                                placeholder="PreÃ§o de venda em {{ config('settings.currencyFormat') }}" id="newSP">
                        </div>
                    </div>
                    <div class="form-group row" id="singlePrice">
                        <label class="col-lg-3 col-form-label"><span class="text-danger">*</span>PreÃ§o:</label>
                        <div class="col-lg-6">
                            <input type="text" class="form-control form-control-lg price" name="price"
                    ...
                    <div class="form-group row">
                        <label class="col-lg-3 col-form-label"><span class="text-danger">*</span>Loja do Item:</label>
                        <div class="col-lg-9">
                    ...
                    <div class="form-group row">
                        <label class="col-lg-3 col-form-label"><span class="text-danger">*</span>Categoria do Item:</label>
                        <div class="col-lg-9">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9">
                            ...
                            <div class="uploader">
                                ...
                                <span class="help-text text-muted">Tamanhos de imagem: 162x118 ou 324x237 ou 486x355 e assim por diante.
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â  (Para obter a melhor qualidade, use 486x355)</span>
                            </div>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-lg-3 col-form-label">Ã recomendado?</label>
                        <div class="col-lg-9">
                    ...
                    <div class="form-group row">
                        <label class="col-lg-3 col-form-label">Ã Popular?</label>
                        <div class="col-lg-9">
                            <div class="checkbox checkbox-switchery mt-2">
                                <label>
                    ...
                    <div class="form-group row">
                        <label class="col-lg-3 col-form-label">Ã novo?</label>
                        <div class="col-lg-9">
                            <div class="checkbox checkbox-switchery mt-2">
                                <label>
                    ...
                    <div class="form-group row">
                        <label class="col-lg-3 col-form-label">Ã vegetariano?</label>
                        <div class="col-lg-9">
                            <div class="checkbox checkbox-switchery mt-2">
                                <label>
...
<div id="addBulkItemModal" class="modal fade mt-5" tabindex="-1">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"><span class="font-weight-bold">Upload em massa de CSV para itens</span></h5>
                <button type="button" class="close" data-dismiss="modal">&times;</button>
            </div>
            <div class="modal-body">
