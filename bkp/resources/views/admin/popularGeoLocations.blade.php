...
@section("title") Localizaçãos Populares - Dashboard
@endsection
@section('content')
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <div class="btn-group btn-group-justified">
                                    @if($location->is_active)
                                    <a href="{{ route('admin.disablePopularGeoLocation', $location->id) }}" class="badge badge-primary badge-icon ml-1" data-popup="tooltip" title="Desativar Localização" data-placement="bottom"> <i class="icon-switch2"></i> </a>
                                    @else
                                    <a href="{{ route('admin.disablePopularGeoLocation', $location->id) }}" class="badge badge-danger badge-icon ml-1" data-popup="tooltip" title="Ativar Localização" data-placement="bottom"> <i class="icon-switch2"></i> </a>
                                    @endif
                                    <a href="{{ route('admin.deletePopularGeoLocation', $location->id) }}" class="badge badge-danger badge-icon ml-1 doubleClickDelete" data-popup="tooltip" title="Clique duplo para apagar {{ $location->name }}" data-placement="bottom"> <i class="icon-trash"></i> </a>
                                </div>
                            </td>
                        </tr>
                        @endforeach
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"><span class="font-weight-bold">Adicionar Nova Localização</span></h5>
            ...
            <div class="modal-body">
                <form action="{{ route('admin.saveNewPopularGeoLocation') }}" method="POST" enctype="multipart/form-data" id="geoLocationForm">
                    <div class="form-group row">
                        <label class="col-lg-3 col-form-label"><span class="text-danger">*</span>Nome da localização:</label>
                        <div class="col-lg-9">
