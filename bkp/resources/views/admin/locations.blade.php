...
@section("title") Localizações - Dashboard
@endsection
@section('content')
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <div class="btn-group btn-group-justified">
                                    ...
                                    @if($location->is_active)
                                    <a href="{{ route('admin.disableLocation', $location->id) }}" class="badge badge-primary badge-icon ml-1" data-popup="tooltip" title="Desativar Localização" data-placement="bottom"> <i class="icon-switch2"></i> </a>
                                    @else
                                    <a href="{{ route('admin.disableLocation', $location->id) }}" class="badge badge-danger badge-icon ml-1" data-popup="tooltip" title="Ativar Localização" data-placement="bottom"> <i class="icon-switch2"></i> </a>
                                    @endif
                                </div>
                            </td>
                        </tr>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-9">
                            <input type="text" class="form-control form-control-lg" name="name"
                                placeholder="Nome da Localização" required>
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-lg-3 col-form-label"><span class="text-danger">*</span>Descrição curta:</label>
                        <div class="col-lg-9">
...
<div id="addBulkLocationModal" class="modal fade mt-5" tabindex="-1">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"><span class="font-weight-bold">Upload em massa de CSV para local</span></h5>
                <button type="button" class="close" data-dismiss="modal">&times;</button>
            </div>
            <div class="modal-body">
