...
@section("title") Configurações - Dashboard
@endsection
@section('content')
<style>
    .disable-switch {
    ...
    <div class="page-header-content header-elements-md-inline">
        <div class="page-title d-flex">
            <h4><i class="icon-circle-right2 mr-2"></i>
                <span class="font-weight-bold mr-2">CONFIGURAÇÕES</span>
            </h4>
        </div>
    </div>
</div>
                        ...
                        <ul class="nav nav-pills flex-column mr-lg-3 wmin-lg-250 mb-lg-0">
                            ...
                            {{-- <li class="nav-item">
                                <a href="{{ route('admin.updateFoodomaa') }}" class="nav-link">
                                    ...
                                    Atualizar <span
                                        class="badge badge-flat border-grey-800 text-danger text-capitalize mr-1 float-right">NOVO</span>
                                </a>
                            </li> --}}
                            <li class="nav-item">
                                <a href="#cacheSettings" class="nav-link" data-toggle="tab">
                                    <i class="icon-database-refresh mr-2"></i>
                                    Configurações de cache <span
                                        class="badge badge-flat border-grey-800 text-danger text-capitalize mr-1 float-right">NOVO</span>
                                </a>
                            </li>
                            <li class="nav-item">
                        ...
                        <div class="tab-content" style="width: 100%; padding: 0 25px;">
                            <div class="tab-pane fade show active" id="generalSettings">
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><strong>Nome da loja:</strong></label>
                                    <div class="col-lg-9">
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><strong>URL da loja:</strong></label>
                                    <div class="col-lg-9">
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label">
                                        <strong>Fuso horário do aplicativo:</strong>
                                    </label>
                                    <div class="col-lg-9">
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><strong>Moeda da loja:</strong></label>
                                    <div class="col-lg-9">
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><strong>Símbolo da moeda:</strong></label>
                                    <div class="col-lg-9">
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><strong>Alinhamento da moeda</strong></label>
                                    <div class="col-lg-9">
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><strong>Mostrar slider promocional? </strong></label>
                                    <div class="col-lg-9">
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><strong>Exibir tag Vegetariano?
                                        </strong></label>
                                    <div class="col-lg-9">
                                        <div class="checkbox checkbox-switchery mt-2">
                                            <label>
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><strong>Embelezar Data/Hora
                                        </strong></label>
                                    <div class="col-lg-9">
                                        <div class="checkbox checkbox-switchery mt-2">
                                            <label>
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><strong>Mostrar caixa de seleção GDPR? </strong></label>
                                    <div class="col-lg-9">
                                        <div class="checkbox checkbox-switchery mt-2">
                                            <label>
                                                <input value="true" type="checkbox" class="switchery-primary"
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><strong>Ativar retirada na loja? </strong></label>
                                    <div class="col-lg-9">
                                        <div class="checkbox checkbox-switchery mt-2">
                                            <label>
                                                <input value="true" type="checkbox" class="switchery-primary"
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><strong>Ativar PIN de entrega?
                                        </strong></label>
                                    <div class="col-lg-9">
                                        <div class="checkbox checkbox-switchery mt-2">
                                            <label>
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><strong>Pagamento mínimo para Loja em
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><strong>Tempo Máximo para Aceitar Pedido:
                                        </strong></label>
                                    <div class="col-lg-9">
                                        ...
                                        <span class="help-text text-muted">Tempo máximo em minutos após o qual admin
                                             recebe uma notificação na página de pedidos de que o dono do Loja não
                                             aceitou o pedido.</span>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><strong>Tempo máximo para aceitar a entrega:
                                        </strong></label>
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control form-control-lg threshold-time"
                                        ...
                                        <span class="help-text text-muted">Tempo máximo em minutos após o qual admin
                                             recebe uma notificação na página de pedidos de que o entregador não aceitou
                                             a ordem.</span>
                                    </div>
                                </div>
                                
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><strong>Campo Código do país padrão no campo "Telefone":
                                        </strong></label>
                                    <div class="col-lg-9">
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><strong>Formulário de ganhos do entregador?
                                        </strong></label>
                                    <div class="col-lg-9">
                                        <div class="checkbox checkbox-switchery mt-2">
                                            <label>
                                                <select name="deliveryGuyCommissionFrom" class="form-control">
                                                    ...
                                                    <option value="DELIVERYCHARGE"
                                                        ...
                                                        ) selected="selected" @endif>Comissão de taxa de entrega
                                                         Valor</option>
                                                </select>
                                            </label>
                                        </div>
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><strong>Ativar modo de desenvolvimento?
                                        </strong></label>
                                    <div class="col-lg-9">
                                        <div class="checkbox checkbox-switchery mt-2">
                                            <label>
                            ...
                            <div class="tab-pane fade" id="seoSettings">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        ...
                                        <span class="help-text text-muted">Tamanho da imagem 1200x630 </span>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><strong>Título dos Cartões do Twitter:
                                        </strong></label>
                                    <div class="col-lg-9">
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><strong>Twitter Cartões
                                             Descrição</strong></label>
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control form-control-lg"
                                ...
                                <div class="form-group row">
                                    ...
                                    @endif
                                    <label class="col-lg-3 col-form-label"><strong>Imagem dos cartões do Twitter:
                                        </strong></label>
                                    <div class="col-lg-9">
                            ...
                            <div class="tab-pane fade" id="designSettings">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        ...
                                        <span class="help-text text-muted">Tamanho 320x89</span>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        ...
                                        <span class="help-text text-muted">Imagem quadrada de tamanho mínimo: 512x512</span>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    @endif
                                    <label class="col-lg-3 col-form-label"><strong>Tela de abertura: </strong></label>
                                    <div class="col-lg-9">
                                        <input type="file" class="form-control-uniform" name="splashLogo" data-fouc>
                                        <span class="help-text text-muted">Tamanho 480x853</span>
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><strong>Cor da loja:</strong></label>
                                    <div class="col-lg-9">
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><strong>Fundo do carrinho
                                             Cor:</strong></label>
                                    <div class="col-lg-9">
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><strong>Tag de Novo Item
                                             Cor:</strong></label>
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control colorpicker-show-input"
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><strong>Tag de item popular
                                             Cor:</strong></label>
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control colorpicker-show-input"
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><strong>Tag de item recomendado
                                             Cor:</strong></label>
                                    <div class="col-lg-9">
                                        <input type="text" class="form-control colorpicker-show-input"
                            ...
                            <div class="tab-pane fade" id="pushNotificationSettings">
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><strong>Ativar Notificações Push</strong></label>
                                    <div class="col-lg-9">
                                        <div class="checkbox checkbox-switchery mt-2">
                                            <label>
                                                <input value="true" type="checkbox" class="switchery-primary"
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><strong>Notificações push para pedido
                                             Atualizações</strong></label>
                                    <div class="col-lg-9">
                                        <div class="checkbox checkbox-switchery mt-2">
                                            <label>
                                                <input value="true" type="checkbox" class="switchery-primary"
                            ...
                            <div class="tab-pane fade" id="socialLoginSettings">
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><strong>Ativar Login com Facebook</strong></label>
                                    <div class="col-lg-9">
                                        <div class="checkbox checkbox-switchery mt-2">
                                            <label>
                                                <input value="true" type="checkbox" class="switchery-primary"
                            ...
                            <div class="tab-pane fade" id="mapSettings">
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label"><strong>Mostrar mapa na página de rastreamento de pedidos?</strong></label>
                                    <div class="col-lg-9">
                                        <div class="checkbox checkbox-switchery mt-2">
                                            <label>
                                                <input value="true" type="checkbox" class="switchery-primary"
                                ...
                                <hr><a href="https://stackcanyon.com/docs/foodomaa/admin-google-maps-api" target="_blank" rel="nofollow">Clique aqui</a>
                            ...
                            <div class="tab-pane fade" id="emailSettings">
                                ...
                                <div>
                                    <p><strong class="text-danger">IMPORTANTE: </strong> Envie um email de teste para o seu email
                                         antes de ativar a funcionalidade de redefinição de senha</p> <button
