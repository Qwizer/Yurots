...
@section("title") Coletas do Delivery - Dashboard
@endsection
@section('content')
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title"><span class="font-weight-bold">Dinheiro em mãos: {{ config('settings.currencyFormat') }} {{ $dC->amount }}</span></h5>
                                    ...
                                    <div class="modal-body">
                                        <form action="{{ route('admin.collectDeliveryCollection', $dC->user_id) }}" method="POST" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group row">
                                                <label class="col-lg-3 col-form-label">Tipo da Coleta:</label>
                                                <div class="col-lg-9">
                                                    <select name="type" class="form-control form-control-lg">
                                                        <option value="FULL">Quantia Total</option>
                                                        <option value="CUSTOM">Quantia Parcial</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="form-group row hidden" id="customAmountDiv">
                                                <label class="col-lg-3 col-form-label">Quantia:</label>
                                                <div class="col-lg-9">
