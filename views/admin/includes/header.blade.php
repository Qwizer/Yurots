...
<div class="navbar navbar-expand-md navbar-dark">
    <div class="navbar-brand wmin-0 mr-5">
        ...
        <img src="{{substr(url("/"), 0, strrpos(url("/"), '/'))}}/assets/backend/global_assets/images/dashboard-logo.png" alt="{{__('storeDashboard.ControlPanel')}}">
        </a>
        @endif
        @role("Store Owner")
        <a href="{{ route('restaurant.dashboard') }}" class="d-inline-block">
        <img src="{{substr(url("/"), 0, strrpos(url("/"), '/'))}}/assets/backend/global_assets/images/dashboard-logo.png" alt="ControlPanel">
        </a>
        @endrole
    </div>
    <div class="d-md-none">
    ...
    <div class="collapse navbar-collapse">
        <ul class="navbar-nav ml-auto">
            ...
            @role("Store Owner")
                @impersonating
                    <li class="nav-item">
                        <a class="navbar-nav-link active" href="{{ route('impersonate.leave') }}"><i class="icon-arrow-left15 mr-1"></i>{{ __('storeDashboard.BacktoAdministration') }}</a>
                    </li>
                @endImpersonating
            @endrole
        </ul>
...
<div class="navbar navbar-expand-md navbar-light navbar-sticky">
    <div class="container">
        <div class="text-center d-md-none w-100">
			...
			{{__('storeDashboard.ControlPanel')}}
            </button>
        </div>
        <div class="navbar-collapse collapse" id="navbar-navigation">
            <ul class="navbar-nav">
                ...
                <li class="nav-item dropdown">
                    ...
                    {{__('storeDashboard.Users')}}
                    </a>
                    <div class="dropdown-menu">
                        <a href="{{ route("admin.users") }}" class="dropdown-item {{ Request::is('admin/users') ? 'active' : ''}}"> <i class="icon-users4 mr-2"></i>{{__('storeDashboard.UserClient')}}</a>
                        <a href="{{ route('admin.manageRestaurantOwners') }}" class="dropdown-item {{ Request::is('admin/manage-store-owners') ? 'active' : ''}}"> <i class="icon-user-tie mr-2"></i>{{__('storeDashboard.ManageStoreOwners')}}</a>
                        <a href="{{ route('admin.manageDeliveryGuys') }}" class="dropdown-item {{ Request::is('admin/manage-delivery-guys') ? 'active' : ''}}"> <i class="icon-truck mr-2"></i>{{__('storeDashboard.ManageDeliveryGuys')}}</a> 
                    </div>
                </li>
                <li class="nav-item">
                    ...
                    <div class="dropdown-menu">
                        <div class="row extra-menu">
                            <div class="col-md-6">
                                ...
                                {{__('storeDashboard.PopularGeoLocations')}}
                                </a>
                                ...
                                {{__('storeDashboard.Notifications')}}
                                </a>
                                <a href="{{ route("admin.modules") }}" class="dropdown-item {{ Request::is('admin/modules') ? 'active' : '' }}">
                                    <i class="icon-stars mr-2"></i>
                                    {{__('storeDashboard.ModulesPremium')}} <span class="badge badge-flat border-grey-800 text-danger text-capitalize ml-1 float-right">NEW</span>
                                </a>
                            </div>
                            <div class="col-md-6">
                                ...
                                {{__('storeDashboard.DeliveryCollections')}}
                                </a>
                                ...
                                {{__('storeDashboard.DeliveryCollectionLogs')}}
                                </a>
